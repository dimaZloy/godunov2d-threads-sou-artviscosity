...
@everywhere function updateOutputSA(
	...
	if (dynControls.verIter == output.verbosity)
		...
		if (solControls.plotResidual == 1)	
			...
			tricontourf(testMesh.xNodes,testMesh.yNodes, testMesh.triangles, testFields.densityNodes, pControls.nContours,vmin=pControls.rhoMINcont,vmax=pControls.rhoMAXcont);
